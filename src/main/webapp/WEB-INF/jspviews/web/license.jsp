...
<div class="container">
	...
	<div  class='row'>
		<form method="post" action="${pageContext.request.contextPath}/web/queryLicense">
						<div class="THREE  columns">
					      <input class="u-full-width" type="text" placeholder="驾驶证号" name='sn'>
					    </div>
	...
	<div class='row' >
		  <div class="sixteen columns">
			<table class="standard-table">
					...
					<c:forEach var="bean" items="${licenses }">
									<tr>
										<td>${bean.sn }</td>
										<td>${bean.name }</td>
										<td>${bean.type }</td>
